        ...
        <View style={styles.overlay}>
            ...
            if (element.type === 'text') {
              return (
                <TextElement
                  ...
                  onUpdate={transform => handleElementUpdate(element.id, transform)}
                />
              );
            }
          ...
          {selectedElementId && (
            <View style={styles.guidesContainer}>
              ...
              <View style={[styles.guide, styles.verticalGuide, { left: canvasWidth / 2 }]} />
              {/* Horizontal center guide */}
              <View style={[styles.guide, styles.horizontalGuide, { top: canvasHeight / 2 }]} />
            </View>
          )}
        </View>
      </GestureDetector>
