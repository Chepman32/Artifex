...
export const STICKERS: { free: AssetItem[]; pro: AssetItem[] } = {
  free: [
    ...
    },
    {
      id: 's10',
      name: 'New Reel Alt',
      file: require('../assets/stickers/social-media/new-reel-alt.png'),
      category: 'social-media',
      isPro: false,
    },
    ...
    },
    {
      id: 's13',
      name: 'Lettering 2',
      file: require('../assets/stickers/text-labels/lettering-2.png'),
      category: 'text-labels',
      isPro: false,
    },
    {
    ...
    },
    {
      id: 's17',
      name: 'Free Label',
      file: require('../assets/stickers/text-labels/free-label.jpg'),
      category: 'text-labels',
      isPro: false,
    },
    {
      id: 's18',
      name: 'New Product',
      file: require('../assets/stickers/text-labels/new-product.jpeg'),
      category: 'text-labels',
      isPro: false,
    },
    {
    ...
    },
    {
      ...
      file: require('../assets/stickers/seasonal/halloween-pumpkin.jpeg'),
      category: 'seasonal',
      isPro: false,
    },
    {
      ...
      file: require('../assets/stickers/seasonal/christmas-santa.jpeg'),
      category: 'seasonal',
      isPro: false,
    },
    {
      ...
      file: require('../assets/stickers/seasonal/thank-you-flowers.jpeg'),
      category: 'seasonal',
      isPro: false,
    },
    ...
    // Food Category
    {
      id: 's28',
      name: 'Smoothie Drink',
      file: require('../assets/stickers/food/drink-smoothie.jpeg'),
      category: 'food',
      isPro: false,
    },
